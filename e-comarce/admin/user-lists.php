                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo 'user-lists.php'; ?>" class="breadcrumb-link">User Lists</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <?php 
                                        ...
                                        if($image){
                                            ...
                                            if(file_exists("images/users/$image")){
                                                ...
                                                $image = "<img class='img-responsive img-fluid img-thumbnail' src='images/users/$image' width='80px'>";
                                            }else{
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <?php 
                                            ...
                                            if($status == 0){
                                                echo "<a href='change-status.php?id=$id&&value=1&&table=users' class='btn btn-danger'>Disable</a>";
                                            }elseif($status == 1){
                                                echo "<a href='change-status.php?id=$id&&value=0&&table=users' class='btn btn-success'>Enable</a>";
                                            }
                                        ?>
                                      </td>
                                      <td>
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <h5 class="text-center">If you want to delete user ?</h5>
                                              </div>
                                              <div class="modal-footer">
                                                <a href='<?php echo "delete-user.php?id=$id"?>' class="btn btn-danger">Yes</a>
